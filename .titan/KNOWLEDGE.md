...
- Committed as `3fb12d3`, deployed to mcp-host
...
- `local=/internal.example.internal/` in dnsmasq blocks upstream DNS forwarding — Caddy-proxied subdomains need explicit `address=` directives in dnsmasq config to resolve locally
